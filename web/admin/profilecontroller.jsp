...
<html>
    ...
    <body>
        ...
        String path="/Users/sangamkumar/Desktop/java/Registration/web/admin/image";
        %>
        <%
        ...
        disFact.setRepository(new File("/Users/sangamkumar/Desktop/java/Registration/web/admin/image"));
