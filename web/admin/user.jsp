                            ...
                            <div class="content">
                                <div class="author">
                                    ...
                                    <%
                                        ...
                                        while(rs.next()){
                                        %>
                                      <h4 class="title">Name: <%=rs.getString("name") %><br />
                                         <small>Email address: <%=rs.getString("email") %></small>
                                      </h4>
                                    
                                </div>
                                <p class="description text-center">Designation: <%=rs.getString("designation") %><br>
