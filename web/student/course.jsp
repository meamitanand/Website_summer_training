<%-- 
    Document   : course
    Created on : Jul 5, 2017, 1:13:34 AM
    Author     : sangamkumar
--%>
                     ...
                     <!--  &nbsp Industry Persons/Faculty Rs. 9000=00  <br>
						...
						-->
                                                <form method="post" action="payment.jsp">
														  ...
														  <input type="radio" name="course" value="8000">Students from other institutions  <input type="submit" class="btn btn-success pull-right" name="go" value="Submit Button"> <br>
  ...
  <div class="panel panel-danger">
    ...
    Connect with the global Cisco Networking Academy community.
	  ...
	  <br>      <br>      <br>
					...
					<div class="collapse" id="collapseExample">
					  <div class="well">
						Demo text.  Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text. Demo text.
					  </div>
	                     </div>
