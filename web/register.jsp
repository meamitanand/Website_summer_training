            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-lg-offset-1 text-center">
                    ...
                    <form role="form" method="post">  
                        ...
                        <tr>
                                <td>Date of Birth</td>
                                <td><input type="date" name="t4" class="form-control" placeholder="DD/MM/YYYY"  required/></td>
                        </tr>
                        <tr>
                        <td>Gender</td>
                        ...
                        <td>Work Experience/Semester</td>
                        ...
                        <td>Pin Code</td>
                        <td>
                            <input type="text" name="t14" class="form-control" maxlength="6" placeholder="Zip code" pattern="[1-9]{1}[0-9]{5}" title="Pin Code" />
                        </td>
                        </tr>

                        <tr>
                        <td>Mobile Number</td>
                        <td><input type="text" id="mob"  name="t15"  class="form-control"  maxlength="10" pattern="[1-9]{1}[0-9]{9}" title="Enter Phone Number" placeholder="Mobile Number"/></td>
                        </tr>
                        ...
                        <tr>
                        <td>Password</td>
                                <td><input type="password" name="t17" class="form-control" /></td>
                        </tr>
                        <tr>
                        <td>Accommodation</td>
